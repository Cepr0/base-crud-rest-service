...
public interface BaseService<ID extends Serializable, T extends BaseElement<ID>, C extends CreateRequest, U extends UpdateRequest, R extends BaseResponse<ID>> {
	R create(C request);
